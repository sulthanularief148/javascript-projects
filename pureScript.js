...
calculatorWrapper.classList.add("bg-[rgba(0,0,0,0.8)]", "flex", "gap-10", "absolute", "left-1/2", "top-1/2", "transform", "-translate-x-1/2", "-translate-y-1/2", "w-full", "md:w-4/12", "p-8", "flex-col", "text-center", "shadow-2xl", "rounded-lg");
...
Operator.classList.add("h-8", "w-full", "rounded-lg", "p-1", "outline-none");
["+", "-", "*", "/"].forEach(op => {
...
calculatorWrapper.appendChild(Operator);
...
calculateButton.classList.add("bg-blue-500", "text-white", "rounded-lg", "p-2");
